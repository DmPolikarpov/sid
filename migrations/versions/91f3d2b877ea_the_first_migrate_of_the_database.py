"""the first migrate of the database
Revision ID: 91f3d2b877ea
Revises: 
Create Date: 2020-07-02 05:54:56.420021
"""
...
def upgrade():
    ...
    sa.Column('open_price', sa.NUMERIC(), autoincrement=False, nullable=False),
    sa.Column('high_price', sa.NUMERIC(), autoincrement=False, nullable=False),
    sa.Column('low_price', sa.NUMERIC(), autoincrement=False, nullable=False),
